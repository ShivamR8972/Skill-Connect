...
# SECRET_KEY = "django-insecure-ft6b2sh=^32&m(%7-jkuylh#97x2k9uoo0gv3_d@fq#q3s$ba+"
...
# PostgreSQL (use your own creds)
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.getenv("POSTGRES_DB", "skillconnect_db"),
